...
import com.app.activemqpub.subscriber.ActiveMqSubscriber1;
...
public class ActiveMqSubscriber {
	...
	public ResponseEntity<String> getHello() throws URISyntaxException, Exception{
		...
		ActiveMqSubscriber1 subscriber = new ActiveMqSubscriber1();
...
//				Message message = session.createTextMessage("Topic 1");
//				return message;
//			}
//		});
