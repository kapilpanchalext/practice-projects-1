...
public class ExamMBAPassFailDataFileReader {
	public List<MBAPassFail> readInputsFromFile(String filePath) {
        List<MBAPassFail> mbaPassfailBeanList = new ArrayList<>();
